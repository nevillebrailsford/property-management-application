...
public class RemoveMonitoredChange extends AbstractChange {
	private static final String CLASS_NAME = RemoveMonitoredChange.class.getName();
	private static final Logger LOGGER = Logger.getLogger(Constants.LOGGER_NAME);

	private MonitoredItem monitoredItem;

	public RemoveMonitoredChange(MonitoredItem monitoredItem) {
