...
public class RemoveInventoryChange extends AbstractChange {
	private static final String CLASS_NAME = RemoveInventoryChange.class.getName();
	private static final Logger LOGGER = Logger.getLogger(Constants.LOGGER_NAME);

	private InventoryItem inventoryItem;

	public RemoveInventoryChange(InventoryItem inventoryItem) {
